...
CrimeCatChoices = (
	('ARSON','ARSON'),
	('ASSAULT','ASSAULT'),
	('ASSAULT_ATTEMPTED','ASSAULT_ATTEMPTED'),
	...
	('ASSAULT_SHOOTING','ASSAULT_SHOOTING'),
	...
	('QUALITY_GAMBLING','QUALITY_GAMBLING'),
	...
	('SEX','SEX'),
	('SEX_BATTERY','SEX_BATTERY'),
	('SEX_OTHER','SEX_OTHER'),
	('SEX_PROSTITUTION','SEX_PROSTITUTION'),
	('SEX_RAPE','SEX_RAPE'),
	('SEX_RAPE_ATTEMPTED','SEX_RAPE_ATTEMPTED'),
	('TRAFFIC','TRAFFIC'),
	('TRAFFIC_ABANDONED_VEHICLE','TRAFFIC_ABANDONED_VEHICLE'),
